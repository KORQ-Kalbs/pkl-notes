  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-slate-950">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute right-0 top-20 h-80 w-80 rounded-full bg-orange-300/18 blur-3xl" />
      </div>
      ...
      <main className="mx-auto grid min-h-screen w-full max-w-7xl items-center gap-10 px-6 py-10 lg:grid-cols-[1.05fr_0.95fr] lg:px-12">
        <section className="order-2 space-y-6 lg:order-1">
          <span className="inline-flex rounded-full border border-orange-500/15 bg-white/70 px-4 py-2 text-sm font-medium text-slate-700 shadow-sm backdrop-blur">
            Start here
          </span>
        ...
        <section className="order-1 rounded-[2rem] border border-white/80 bg-white/78 p-6 shadow-[0_24px_90px_rgba(15,23,42,0.12)] backdrop-blur-2xl sm:p-8 lg:order-2">
          ...
          <div className="mt-8 space-y-4">
            <label className="block space-y-2">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-slate-200 bg-white/90 px-4 py-3 text-sm text-slate-950 outline-none transition placeholder:text-slate-400 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10"
              />
            </label>
